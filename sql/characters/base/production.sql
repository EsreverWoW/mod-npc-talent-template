...
--    ('Rogue', 'Subtlety', 17, 42451, 0, 0, 0, 0, 0, 0),
    ...
    ('Druid', 'Balance', 5, 40696, 0, 3488, 3448, 0, 2873, 3729),
    ('Druid', 'Balance', 6, 37854, 3719, 0, 0, 0, 0, 0),
    ('Druid', 'Balance', 7, 44202, 2940, 3488, 0, 0, 0, 0),
    ('Druid', 'Balance', 8, 37361, 2332, 0, 0, 0, 0, 0),
    ('Druid', 'Balance', 9, 42111, 3246, 0, 0, 0, 0, 0),
    ('Druid', 'Balance', 10, 37651, 0, 0, 0, 0, 0, 0),
    ('Druid', 'Balance', 11, 40585, 0, 0, 0, 0, 0, 0),
    ('Druid', 'Balance', 12, 40682, 0, 0, 0, 0, 0, 0),
    ('Druid', 'Balance', 13, 37660, 0, 0, 0, 0, 0, 0),
    ('Druid', 'Balance', 14, 37630, 3831, 0, 0, 0, 0, 0),

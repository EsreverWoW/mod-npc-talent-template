...
INSERT INTO `template_npc_alliance` (`playerClass`, `playerSpec`, `pos`, `itemEntry`, `enchant`, `socket1`, `socket2`, `socket3`, `bonusEnchant`, `prismaticEnchant`) VALUES
    ...
    ('Rogue', 'Assassination', 4, 39558, 3832, 3497, 3501, 0, 3301, 0),
    ('Rogue', 'Assassination', 5, 40694, 0, 3497, 3497, 0, 0, 3729),
    ('Rogue', 'Assassination', 6, 37644, 3823, 0, 0, 0, 0, 0),
    ('Rogue', 'Assassination', 7, 44297, 2939, 0, 0, 0, 0, 0),
    ('Rogue', 'Assassination', 8, 37366, 3845, 0, 0, 0, 0, 0),
    ('Rogue', 'Assassination', 9, 39560, 1603, 3497, 0, 0, 2936, 0),
    ('Rogue', 'Assassination', 10, 40586, 0, 0, 0, 0, 0, 0),
    ('Rogue', 'Assassination', 11, 37642, 0, 0, 0, 0, 0, 0),
    ('Rogue', 'Assassination', 12, 40684, 0, 0, 0, 0, 0, 0),
    ('Rogue', 'Assassination', 13, 37390, 0, 0, 0, 0, 0, 0),
    ('Rogue', 'Assassination', 14, 34241, 1099, 3497, 0, 0, 3114, 0),

...
--    ('Rogue', 'Subtlety', 17, 42451, 0, 0, 0, 0, 0, 0),
    ...
    ('Druid', 'Balance', 0, 41327, 3796, 3621, 3520, 0, 3352, 0),
    ('Druid', 'Balance', 1, 42044, 0, 0, 0, 0, 0, 0),
    ('Druid', 'Balance', 4, 41316, 3245, 3520, 3531, 0, 3600, 0),
    ('Druid', 'Balance', 2, 41281, 3794, 3531, 0, 0, 2890, 0),
    ('Druid', 'Balance', 5, 41631, 0, 3879, 3520, 0, 2872, 3729),
    ('Druid', 'Balance', 6, 41304, 3721, 3520, 3548, 0, 3602, 0),
    ('Druid', 'Balance', 7, 41636, 3232, 3531, 0, 0, 2878, 0),
    ('Druid', 'Balance', 8, 41641, 2332, 0, 0, 0, 0, 0),
    ('Druid', 'Balance', 9, 41293, 3246, 3548, 0, 0, 2890, 0),
    ('Druid', 'Balance', 10, 42118, 0, 0, 0, 0, 0, 0),
    ('Druid', 'Balance', 11, 47928, 0, 3520, 0, 0, 3752, 0),
    ('Druid', 'Balance', 12, 42137, 0, 0, 0, 0, 0, 0),
    ('Druid', 'Balance', 13, 51377, 0, 0, 0, 0, 0, 0),
    ('Druid', 'Balance', 14, 42076, 3243, 0, 0, 0, 0, 0),
    ('Druid', 'Balance', 15, 42364, 3854, 3520, 3535, 0, 3602, 0),
    ('Druid', 'Balance', 17, 42584, 0, 0, 0, 0, 0, 0),
...
--    ('Rogue', 'Subtlety', 17, 42451, 0, 0, 0, 0, 0, 0),
    ...
    ('Druid', 'Balance', 9, 41293, 3246, 3548, 0, 0, 2890, 0),
    ('Druid', 'Balance', 10, 42118, 0, 0, 0, 0, 0, 0),
    ('Druid', 'Balance', 11, 48001, 0, 3520, 0, 0, 3752, 0),
    ('Druid', 'Balance', 12, 42137, 0, 0, 0, 0, 0, 0),
    ('Druid', 'Balance', 13, 51378, 0, 0, 0, 0, 0, 0),
    ('Druid', 'Balance', 14, 42076, 3243, 0, 0, 0, 0, 0),
    ('Druid', 'Balance', 15, 42364, 3854, 3520, 3535, 0, 3602, 0),
    ('Druid', 'Balance', 17, 42584, 0, 0, 0, 0, 0, 0),
    ('Priest', 'Holy', 0, 41854, 3796, 3621, 3520, 0, 3352, 0),
